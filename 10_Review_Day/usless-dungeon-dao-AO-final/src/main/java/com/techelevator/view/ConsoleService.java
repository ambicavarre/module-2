...
public class ConsoleService {
    ...
    public static void printHeroStats(Hero myHero){
        System.out.println("Hero Name: " + myHero.getName());
        System.out.println("Hero Profession: " + myHero.getProfession().getProfessionName());
        System.out.println("Hero Health: " + myHero.getHealth());
        System.out.println("Hero Defense: " + myHero.getDefense());
    }
    //User Input Methods
    ...
    public static boolean promptForSaveCharacter(){
        Scanner userInput = new Scanner(System.in);
        while (true){
            System.out.println("Would you like to save this hero?");
